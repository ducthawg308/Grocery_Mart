                                    ...
                                    <aside class="profile__sidebar">
                                        ...
                                        <div class="profile-menu">
                                            ...
                                            <ul class="profile-menu__list">
                                                <li>
                                                    <a href="?module=page&action=edit-personal-info" class="profile-menu__link">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row gy-md-2 row-cols-3 row-cols-xl-2 row-cols-lg-1">
                                                    ...
                                                    <div class="col">
                                                        <a class="new-card" href="?module=page&action=add-new-card">
                                                            <img
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row gy-md-2 row-cols-2 row-cols-lg-1">
                                                    <!-- Account info 1 -->
                                                    <div class="col">
                                                        <a href="?module=page&action=edit-personal-info">
